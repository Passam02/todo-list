...
var readTodos = function () {
    ...
    while (i--) {
        var localItem = localStorage.getItem(keys[i]);
        var parsedItem = JSON.parse(localItem);
...
todos.forEach(function (element) {
    ...
    if (Object.keys(element.points).length != 0) {
        var keys = Object.keys(element.points);
        var i = keys.length;
        var _loop_1 = function () {
            var list_1 = todos.find(function (c) { return c.id === mainId.value; });
            var liId = document.createElement('input');
            var pointId = element.points[keys[i]].id;
            if (element.points[keys[i]].text != '') {
                var thisId_1 = pointId;
                var div_1 = document.createElement('div');
                div_1.className = 'border-bottom border-dark d-flex align-items-center p-2';
                var aDelete_1 = document.createElement('a');
                aDelete_1.innerHTML = '<svg style="color: red" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16"><path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/></svg>';
                aDelete_1.addEventListener('click', function () {
                    div_1.remove();
                    delete list_1.points[thisId_1];
                    removeLocalPoint(id, pointId);
                });
                var aChecked_1 = document.createElement('a');
                aChecked_1.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-square-fill" viewBox="0 0 16 16"><path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z"/></svg>';
                aChecked_1.style.cssText = "display: none";
                aChecked_1.addEventListener('click', function () {
                    li_1.style.cssText = '';
                    aChecked_1.style.cssText = 'display: none';
                    aCheck_1.style.cssText = 'dislay: block';
                    isChecked(false, id, pointId);
                });
                var aCheck_1 = document.createElement('a');
                aCheck_1.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-square" viewBox="0 0 16 16"><path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/><path d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.235.235 0 0 1 .02-.022z"/></svg>';
                aCheck_1.addEventListener('click', function () {
                    li_1.style.cssText = 'text-decoration: line-through';
                    buttons_1.append(aChecked_1);
                    aCheck_1.style.cssText = 'display: none';
                    aChecked_1.style.cssText = 'display: block';
                    isChecked(true, id, pointId);
                });
                var li_1 = document.createElement('li');
                li_1.innerText = element.points[pointId].text;
                li_1.style.cssText = 'overflow-wrap: anywhere';
                li_1.className = 'flex-grow-1 fs-5';
                div_1.append(li_1);
                var buttons_1 = document.createElement('div');
                buttons_1.append(aDelete_1);
                buttons_1.append(aCheck_1);
                buttons_1.append(aChecked_1);
                buttons_1.className = 'd-flex flex-column';
                div_1.append(buttons_1);
                pointDiv.prepend(div_1);
            }
        };
        while (i--) {
            _loop_1();
